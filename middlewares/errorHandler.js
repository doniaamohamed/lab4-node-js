...
Tasks: - Create middlewares/errorHandler.js - Handle APIError instances - Handle MongoDB errors: -
 CastError (invalid ObjectId format) - MongoServerError with code 11000 (duplicate key) - ValidationErro
 r (Mongoose validation errors) - Return appropriate error responses with consistent format: json 
 { "message": "Error message", "success": false, "isClientError": true/false } - Handle unexpected errors
   (500 status)
